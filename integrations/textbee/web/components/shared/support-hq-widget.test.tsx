...
beforeEach(() => {
  process.env.NEXT_PUBLIC_SUPPORT_HQ_PROJECT_ID = 'project_1'
  init.mockClear()
  destroy.mockClear()
  // @ts-ignore
...
afterEach(() => {
  delete process.env.NEXT_PUBLIC_SUPPORT_HQ_PROJECT_ID
  document
...
describe('SupportHQWidget', () => {
  it('does not load the optional widget when its project ID is absent', () => {
    delete process.env.NEXT_PUBLIC_SUPPORT_HQ_PROJECT_ID
